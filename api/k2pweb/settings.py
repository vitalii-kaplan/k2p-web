...
RETENTION_FAILED_DAYS = env_int("RETENTION_FAILED_DAYS", 30)
RETENTION_SUCCEEDED_DAYS = env_int("RETENTION_SUCCEEDED_DAYS", 30)
RETENTION_CLEANUP_INTERVAL_SECS = env_int("RETENTION_CLEANUP_INTERVAL_SECS", 300)
